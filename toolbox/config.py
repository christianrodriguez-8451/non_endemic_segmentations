...
audience_dict = {
  ...
  "super_bowl": {
    "frontend_name": "The Big Game",
    "segment_type": "Seasonal",
    "propensity_compisition": ["H"],
    "tags": ["Seasonal"],
  },
  "valentines_day": {
    "frontend_name": "Valentine's Day",
    "segment_type": "Seasonal",
    "propensity_compisition": ["H"],
    "tags": ["Seasonal"],
  },
  "st_patricks_day": {
    "frontend_name": "St. Patrick's Day",
    "segment_type": "Seasonal",
    "propensity_compisition": ["H"],
    "tags": ["Seasonal"],
  },
  "may_5th": {
    "frontend_name": "Cinco de Mayo",
    "segment_type": "Seasonal",
    "propensity_compisition": ["H"],
    "tags": ["Seasonal"],
  },
  "mothers_day": {
    "frontend_name": "Mother's Day",
    "segment_type": "Seasonal",
    "propensity_compisition": ["H"],
    "tags": ["Seasonal"],
  },
  "memorial_day": {
    "frontend_name": "Memorial Day",
    "segment_type": "Seasonal",
    "propensity_compisition": ["H"],
    "tags": ["Seasonal"],
  },
  "fathers_day": {
    "frontend_name": "Father's Day",
    "segment_type": "Seasonal",
    "propensity_compisition": ["H"],
    "tags": ["Seasonal"],
  },
  "july_4th": {
    "frontend_name": "July 4th",
    "segment_type": "Seasonal",
    "propensity_compisition": ["H"],
    "tags": ["Seasonal"],
  },
  "labor_day": {
    "frontend_name": "Labor Day",
    "segment_type": "Seasonal",
    "propensity_compisition": ["H"],
    "tags": ["Seasonal"],
  },
  "thanksgiving": {
    "frontend_name": "Thanksgiving",
    "segment_type": "Seasonal",
    "propensity_compisition": ["H"],
    "tags": ["Seasonal"],
  },
  "new_years_eve": {
    "frontend_name": "New Year's Eve",
    "segment_type": "Seasonal",
    "propensity_compisition": ["H"],
    "tags": ["Seasonal"],
  },
  "gift_cards": {
    "frontend_name": "PLACEHOLDER FOR gift_cards",
    "segment_type": "Household",
    "propensity_compisition": ["H", "M"],
    "tags": ["Lifestyle"],
  },
  "gift_cards_dining": {
    "frontend_name": "PLACEHOLDER FOR gift_cards_dining",
    "segment_type": "Household",
    "propensity_compisition": ["H", "M"],
    "tags": ["Lifestyle"],
  },
  "premade_meals": {
    "frontend_name": "PLACEHOLDER FOR premade_meals",
    "segment_type": "Food & Beverage",
    "propensity_compisition": ["H", "M"],
    "tags": ["Food"],
  },
