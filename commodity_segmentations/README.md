...
The commodity/sub-commodity combinations and their respective segmentations are stored in a control file. For each combination, the most current UPCs are pulled from ACDS to ensure accuracy. The location of the live control file is stored in the config.py file.
